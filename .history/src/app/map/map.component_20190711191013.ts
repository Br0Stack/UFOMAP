  ...
  ngAfterViewInit(){
   //var require: any
    ...
    for (let a = 0; a < 10000; a++) {
      ...
      this.CanvasIconLayer = new CanvasIconLayer({});
      
      this.CanvasIconLayer.addTo(this.mymap);
    ...
    this.CanvasIconLayer.addLayers(markers);
     this.mymap.addLayer(this.CanvasIconLayer);
